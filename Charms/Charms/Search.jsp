...
<div class="article">
  <h1 align="center">Searched File Contains</h1>
        <br/>
        
            <table width="965" border="1" align="center">
  <tr>
   <td ><div align="center"><span class="style3"><strong>FileName</strong></span></div></td>
      <td ><div align="center"><span class="style3"><strong>OwnerName</strong> </span></div></td>
    <td ><div align="center"><span class="style3"><strong>Uploaded Date</strong></span></div></td>
  </tr>
      	...
      	try 
	{
      		...
      		String query="select * from charm_cloudserver where fname='"+fname+"' and cname='"+clo+"'"; 
