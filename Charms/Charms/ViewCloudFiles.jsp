...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
        ...
        <div class="article">
    <h2 align="center">Cloud Files</h2>
        <p align="center">&nbsp;</p>
        <table width="965" border="1" align="center">
  <tr>
   <td width="140" height="32"><div align="center"><span class="style3"><b>File Name</b> </span></div></td>
    <td width="178"><div align="center"><span class="style3"><b>Owner Name</b> </span></div></td>
         <td width="293"><div align="center"><span class="style3"><b>MAC</b> </span></div></td>
    <td width="178"><div align="center"><span class="style3"><b>Cloud Name</b> </span></div></td>
      <td width="293"><div align="center"><span class="style3"><b>VM Name</b> </span></div></td>
    <td width="178"><div align="center"><span class="style3"><b>Secret Key</b> </span></div></td>
    <td width="115"><div align="center"><span class="style3"><b>Rank </b></span></div></td>
    <td width="205"><div align="center"><span class="style3"><b>Date & Time</b></span></div></td>
  </tr>
...
String cn=(String) application.getAttribute("cloudName");
      	try 
	{
      		...
      		String query="select * from charm_CloudServer where cname='"+cn+"' "; 
