...
<div id="bodymiddlePanj">
   <h2 align="center">Response to ur  Req File Details</h2>
...
<%
	...
	try {
		...
		String query = "select * from charm_userrequest where username='"
				+ ename + "' and userfrm='" + clo + "' ";
...
<h4><a href="EndUserMain.jsp">Back</a></h4>
        </div>
      </div>
