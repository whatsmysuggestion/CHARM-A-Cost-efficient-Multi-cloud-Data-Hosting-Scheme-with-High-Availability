...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
        ...
        <div class="article">
      <h1 align="center" class="style1">Memory Utilization</h1>
...
<div class="img"></div>
<div>
<form id="form1" name="form1" method="post" action="MemoryUtil.jsp">
...
<br />
  <p align="center" class="infopost style6"><span class="style2">Memory Utilization Details</span><br />
</p>
...
<table width="965" border="1" align="center">
	<tr>
		...
		<div align="center"><span class="style3">Cloud Name </span></div>
				...
				<td width="293">
		<div align="center"><span class="style3">VM Used fpr this file </span></div>
		</td>
		<td width="293">
		<div align="center"><span class="style3">Remaining VM REsource</span></div>
		</td>
