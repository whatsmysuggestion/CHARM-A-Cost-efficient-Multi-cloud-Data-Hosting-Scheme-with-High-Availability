...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
        ...
        <div class="article">
    <h2 align="center">Attacker Details</h2>
        <p align="center">&nbsp;</p>
        <table width="965" border="1" align="center">
  <tr>
   <td width="140" height="32"><div align="center"><span class="style3"><b>User Name</b> </span></div></td>
    <td width="178"><div align="center"><span class="style3"><b>File Name</b> </span></div></td>
    ...
    <td width="115"><div align="center"><span class="style3"><b>Type </b></span></div></td>
...
String cn=(String) application.getAttribute("cloudName");
      	try 
	{
      		...
      		String query="select * from charm_attacker where cname='"+cn+"' "; 
