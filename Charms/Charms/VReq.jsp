...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
        <div class="article">
        <h2 align="center">Request File Details</h2>
           <table width="965" border="1" align="center">
  <tr>
   <td width="140" height="32"><div align="center"><span class="style3">USER Name </span></div></td>
     <td width="293"><div align="center"><span class="style3">OwnerName</span></div></td>     
      <td width="293"><div align="center"><span class="style3">CloudName</span></div></td>     
       <td width="293"><div align="center"><span class="style3">FnameReq </span></div></td>
      <td width="293"><div align="center"><span class="style3">Sk</span></div></td>
    <td width="115"><div align="center"><span class="style3">Requested Date </span></div></td>
        <td width="115"><div align="center"><span class="style3">Response Date </span></div></td>
            <td width="115"><div align="center"><span class="style3">Status </span></div></td>
  </tr>
<%
...
<tr>
	...
	<div align="center"><%=s8%></div>
		...
		<td>
	<div align="center"><a href="response.jsp?id=<%=i %>&name=<%=s2 %>&cname=<%=s4 %>&fname=<%=s5 %>"><%=s9%></a></div>
	</td>
