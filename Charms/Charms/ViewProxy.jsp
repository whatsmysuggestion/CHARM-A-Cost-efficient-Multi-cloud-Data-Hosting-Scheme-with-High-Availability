...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
        <div class="article">
          ...
          <div class="img"></div>
          <div>
            <h2 align="center">Proxy Files</h2>
  ...
  <tr>
   <td width="140" height="32"><div align="center"><span class="style3">File Name </span></div></td> 
    ...
    <td width="115"><div align="center"><span class="style3">MAC </span></div></td>
      <td width="293"><div align="center"><span class="style3">SK </span></div></td>
          <td width="115"><div align="center"><span class="style3">Memory </span></div></td>
      	...
      	try 
	{
      		...
      		String query="select * from charm_proxyserver"; 
